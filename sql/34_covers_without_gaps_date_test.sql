...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to), daterange('2017-11-22', '2017-11-24'))
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to), daterange('2017-11-23', '2017-11-28'))
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra behind:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to), daterange('2017-11-22', '2017-11-26'))
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra on both sides:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to), daterange('2017-11-23', '2017-11-26'))
FROM    date_shifts
WHERE   job_id = 1;
