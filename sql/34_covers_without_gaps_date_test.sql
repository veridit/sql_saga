...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', '2017-11-24', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range matches two exactly:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', '2017-11-28', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra in front:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-23', '2017-11-28', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra behind:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', '2017-11-26', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra on both sides:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-23', '2017-11-26', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('-infinity', '2017-11-28', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 3;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', 'infinity', '(]') ORDER BY valid_after)
FROM    date_shifts
WHERE   job_id = 4;
...
SELECT  sql_saga.covers_without_gaps(NULL, daterange('2017-11-22', '2017-11-28', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range misses completely:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-29', '2017-11-30', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something at the beginning:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-21', '2017-11-28', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something at the end:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', '2017-11-29', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something in the middle:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', '2017-11-28', '(]'))
FROM    date_shifts
WHERE   job_id = 2;

-- it does not cover when the range is lower-unbounded:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('-infinity', '2017-11-28', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range is upper-unbounded:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-22', 'infinity', '(]'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range is both-sides-unbounded:
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('-infinity', 'infinity', '(]'))
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('-infinity', '2017-11-29', '(]'))
FROM    date_shifts
WHERE   job_id = 3;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), daterange('2017-11-21', 'infinity', '(]'))
FROM    date_shifts
WHERE   job_id = 4;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]'), null)
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(daterange(valid_after,valid_to, '(]') , daterange('2017-11-25', '2017-11-27', '(]') ORDER BY worker_id DESC)
FROM    date_shifts
WHERE   job_id = 1;
