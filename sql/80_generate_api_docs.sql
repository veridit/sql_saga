...
WITH funcs AS (
    SELECT
        ...
        CASE
            ...
            WHEN p.proname IN ('add_foreign_key', 'drop_foreign_key', 'drop_foreign_key_by_name') THEN 3
            WHEN p.proname IN ('add_current_view', 'drop_current_view', 'add_for_portion_of_view', 'drop_for_portion_of_view') THEN 4
            WHEN p.proname = 'temporal_merge' THEN 5
        ...
        CASE
            ...
            WHEN p.proname IN ('add_foreign_key', 'drop_foreign_key', 'drop_foreign_key_by_name') THEN 'Foreign Keys'
            ...
            WHEN p.proname = 'temporal_merge' THEN 'Bulk Data Loading'
