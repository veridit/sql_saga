...
SELECT sql_saga.add_era('tmrb.my_stat_for_unit'::regclass, 'valid_range',
...
SELECT sql_saga.add_era('tmrb.my_stat_for_unit_bad_pk'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
CREATE TABLE tmrb.my_stat_for_unit_good_pk (
    ...
    valid_from date NOT NULL,
    valid_until date,
    PRIMARY KEY (id, valid_range WITHOUT OVERLAPS) -- Correct: Composite PK
);
SELECT sql_saga.add_era('tmrb.my_stat_for_unit_good_pk'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
TRUNCATE source_data_1;
INSERT INTO source_data_1 VALUES (1, 1, NULL, 100, 4, '2023-01-01', '2023-04-01');
...
SELECT sql_saga.add_era('tmrb.my_stat_for_unit_gen_always'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
SELECT sql_saga.add_era('tmrb.my_stat_for_unit_gen_default'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
SELECT sql_saga.add_era('tmrb.bug_repro_1'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
SELECT sql_saga.add_era('tmrb.legal_unit_kranloft'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until',
...
CREATE TABLE tmrb.ephemeral_validation (
    id int, name text, valid_range daterange NOT NULL, valid_from date, valid_until date, valid_to date
);
SELECT sql_saga.add_era('tmrb.ephemeral_validation'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until',
    valid_to_column_name => 'valid_to');
...
CREATE TABLE tmrb.legal_unit_fk_bug (
    id int, name text, valid_range daterange NOT NULL, valid_from date, valid_until date
);
SELECT sql_saga.add_era('tmrb.legal_unit_fk_bug'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
CREATE TABLE tmrb.activity_fk_bug (
    id int, legal_unit_id int, activity_code text, valid_range daterange NOT NULL, valid_from date, valid_until date
);
SELECT sql_saga.add_era('tmrb.activity_fk_bug'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
CREATE TABLE tmrb.unit_default_bug (
    id int, name text, is_active boolean NOT NULL DEFAULT true, valid_range daterange NOT NULL, valid_from date, valid_until date, PRIMARY KEY (id, valid_range WITHOUT OVERLAPS)
);
SELECT sql_saga.add_era('tmrb.unit_default_bug'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
...
SELECT sql_saga.add_era('tmrb.coalesce_bug'::regclass, 'valid_range',
    valid_from_column_name => 'valid_from',
    valid_until_column_name => 'valid_until');
SELECT sql_saga.add_unique_key('tmrb.coalesce_bug'::regclass, '{id}');

-- 2. Initial State
INSERT INTO tmrb.coalesce_bug(id, value, edit_comment, valid_from, valid_until) VALUES (1, 100, 'Old Comment', '2023-01-01', '2023-02-01');
