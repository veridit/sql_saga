...
BEGIN;
  ...
  CALL sql_saga.temporal_merge(p_target_table => 'legal_unit_tm'::regclass, p_source_table => 'legal_unit_seed_source'::regclass, p_identity_columns => ARRAY['id'], p_ephemeral_columns => ARRAY[]::TEXT[]);
  CALL sql_saga.temporal_merge(p_target_table => 'establishment_tm'::regclass, p_source_table => 'establishment_seed_source'::regclass, p_identity_columns => ARRAY['id'], p_ephemeral_columns => ARRAY[]::TEXT[]);
END;
...
BEGIN;
  ...
  CALL sql_saga.temporal_merge(p_target_table => 'legal_unit_tm'::regclass, p_source_table => 'legal_unit_source'::regclass, p_identity_columns => ARRAY['id'], p_ephemeral_columns => ARRAY[]::TEXT[]);
  CALL sql_saga.temporal_merge(p_target_table => 'establishment_tm'::regclass, p_source_table => 'establishment_source'::regclass, p_identity_columns => ARRAY['id'], p_ephemeral_columns => ARRAY[]::TEXT[]);
END;
