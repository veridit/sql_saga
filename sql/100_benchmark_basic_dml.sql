...
\set benchmark_explain_log_filename expected/performance/100_benchmark_basic_dml_legal_unit_explain.log
\set benchmark_source_table 'legal_unit_source'
\set benchmark_target_table 'legal_unit'
...
\set benchmark_explain_log_filename expected/performance/100_benchmark_basic_dml_establishment_explain.log
\set benchmark_source_table 'establishment_source'
\set benchmark_target_table 'establishment'
\i sql/include/benchmark_explain_log.sql
