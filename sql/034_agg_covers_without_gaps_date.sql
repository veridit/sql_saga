...
SELECT sql_saga.add_era('date_shifts', 'valid_range', add_bounds_check := false);
...
INSERT INTO date_shifts(job_id, worker_id, valid_range) VALUES
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', '2017-11-25') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range matches two exactly:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', '2017-11-29') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra in front:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-24', '2017-11-29') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra behind:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', '2017-11-27') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 1;

-- it covers when the range has extra on both sides:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-24', '2017-11-27') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('-infinity', '2017-11-29') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 3;
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', 'infinity') ORDER BY valid_range)
FROM    date_shifts
WHERE   job_id = 4;
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-30', '2017-12-01'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something at the beginning:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-22', '2017-11-29'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something at the end:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', '2017-11-30'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range has something in the middle:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', '2017-11-29'))
FROM    date_shifts
WHERE   job_id = 2;

-- it does not cover when the range is lower-unbounded:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('-infinity', '2017-11-29'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range is upper-unbounded:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-23', 'infinity'))
FROM    date_shifts
WHERE   job_id = 1;

-- it does not cover when the range is both-sides-unbounded:
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('-infinity', 'infinity'))
FROM    date_shifts
WHERE   job_id = 1;
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('-infinity', '2017-11-30'))
FROM    date_shifts
WHERE   job_id = 3;
...
SELECT  sql_saga.covers_without_gaps(valid_range, daterange('2017-11-22', 'infinity'))
FROM    date_shifts
WHERE   job_id = 4;
...
SELECT  sql_saga.covers_without_gaps(valid_range , daterange('2017-11-26', '2017-11-28') ORDER BY worker_id DESC)
FROM    date_shifts
WHERE   job_id = 1;
