...
SAVEPOINT test;
INSERT INTO rooms(id,house_id,valid_range) VALUES (1, 1, '[2016-06-01,2017-01-01)');
DELETE FROM houses WHERE id = 1 and valid_range @> '2015-06-01'::DATE;
...
DELETE FROM houses WHERE id = 1 and valid_range @> '2016-06-01'::DATE;
ROLLBACK TO SAVEPOINT test;
...
DELETE FROM houses WHERE id = 3 and valid_range @> '2016-01-01'::DATE;
ROLLBACK TO SAVEPOINT test;
