...
SELECT sql_saga.add_era('shifts', 'valid_from', 'valid_until');
SELECT sql_saga.add_era('houses', 'valid_from', 'valid_until', 'valid');
SELECT sql_saga.add_era('rooms', 'valid_from', 'valid_until');
TABLE sql_saga.era;
...
BEGIN
  PERFORM sql_saga.add_era('shifts', 'valid_from', 'valid_until');
  PERFORM sql_saga.add_unique_key('shifts', ARRAY['job_id','worker_id'], 'valid');

  PERFORM sql_saga.add_era('houses', 'valid_from', 'valid_until', 'valid');
  PERFORM sql_saga.add_unique_key('houses', ARRAY['id'], 'valid');

  PERFORM sql_saga.add_era('rooms', 'valid_from', 'valid_until');
