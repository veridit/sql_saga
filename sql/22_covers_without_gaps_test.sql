...
INSERT INTO covers_test_shifts(job_id, worker_id, valid_from, valid_until) VALUES
...
SELECT job_id, sql_saga.covers_without_gaps(tstzrange(valid_from, valid_until), r)
FROM covers_test_shifts,
LATERAL (SELECT 
    CASE job_id
