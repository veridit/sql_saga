...
BEGIN
    ...
    EXECUTE format($$ CREATE FUNCTION %1$I.%2$I(timestamp with time zone) RETURNS SETOF %1$I.%3$I LANGUAGE sql STABLE AS 'SELECT * FROM %1$I.%3$I WHERE %4$I @> $1' $$, table_schema /* %1$I */, function_as_of_name /* %2$I */, view_name /* %3$I */, era_row.range_column_name /* %4$I */);
    ...
    EXECUTE format($$ CREATE FUNCTION %1$I.%2$I(timestamp with time zone, timestamp with time zone) RETURNS SETOF %1$I.%3$I LANGUAGE sql STABLE AS 'SELECT * FROM %1$I.%3$I WHERE %4$I && tstzrange($1, $2, ''[]'')' $$, table_schema /* %1$I */, function_between_name /* %2$I */, view_name /* %3$I */, era_row.range_column_name /* %4$I */);
    ...
    EXECUTE format($$ CREATE FUNCTION %1$I.%2$I(timestamp with time zone, timestamp with time zone) RETURNS SETOF %1$I.%3$I LANGUAGE sql STABLE AS 'SELECT * FROM %1$I.%3$I WHERE %4$I && tstzrange(least($1, $2), greatest($1, $2), ''[]'')' $$, table_schema /* %1$I */, function_between_symmetric_name /* %2$I */, view_name /* %3$I */, era_row.range_column_name /* %4$I */);
